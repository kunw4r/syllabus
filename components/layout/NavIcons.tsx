...
export function CompassIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function LibraryIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function SocialIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function ProfileIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function TrophyIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function FilmIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function TvIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function BookIcon({ size = 24, active }: IconProps) {
  return active ? (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" style={s}>
...
export function LogInIcon({ size = 24, active }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={s}>
...
export function LogOutIcon({ size = 24, active }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={s}>
