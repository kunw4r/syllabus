...
export const STUDIOS: Studio[] = [
  // Major studios
  { slug: 'disney', name: 'Disney', tmdb_id: 2, color: 'from-blue-500 to-blue-700', icon: '' },
  { slug: 'pixar', name: 'Pixar', tmdb_id: 3, color: 'from-green-400 to-emerald-600', icon: '' },
  { slug: 'marvel', name: 'Marvel Studios', tmdb_id: 420, color: 'from-red-500 to-red-700', icon: '' },
  { slug: 'dc', name: 'DC Studios', tmdb_id: 9993, color: 'from-blue-600 to-indigo-800', icon: '' },
  { slug: 'warner-bros', name: 'Warner Bros.', tmdb_id: 174, color: 'from-yellow-500 to-amber-700', icon: '' },
  { slug: 'searchlight', name: 'Searchlight Pictures', tmdb_id: 43, color: 'from-amber-400 to-yellow-600', icon: '' },
  { slug: 'amblin', name: 'Amblin Partners', tmdb_id: 56, color: 'from-indigo-400 to-indigo-600', icon: '' },
  { slug: 'working-title', name: 'Working Title', tmdb_id: 10163, color: 'from-stone-400 to-stone-600', icon: '' },
  { slug: 'universal', name: 'Universal', tmdb_id: 33, color: 'from-sky-400 to-sky-600', icon: '' },
  { slug: 'paramount', name: 'Paramount', tmdb_id: 4, color: 'from-blue-400 to-blue-600', icon: '' },
  { slug: 'sony', name: 'Sony Pictures', tmdb_id: 34, color: 'from-slate-400 to-slate-600', icon: '' },
  { slug: 'lionsgate', name: 'Lionsgate', tmdb_id: 1632, color: 'from-orange-500 to-orange-700', icon: '' },
  { slug: 'a24', name: 'A24', tmdb_id: 41077, color: 'from-neutral-400 to-neutral-600', icon: '' },
  { slug: 'focus-features', name: 'Focus Features', tmdb_id: 10146, color: 'from-violet-400 to-purple-600', icon: '' },
  { slug: 'miramax', name: 'Miramax', tmdb_id: 14, color: 'from-zinc-400 to-zinc-600', icon: '' },
  { slug: 'skydance', name: 'Skydance', tmdb_id: 82819, color: 'from-sky-300 to-cyan-500', icon: '' },
  // Animation & genre
  { slug: 'dreamworks', name: 'DreamWorks', tmdb_id: 521, color: 'from-cyan-400 to-teal-600', icon: '' },
  { slug: 'illumination', name: 'Illumination', tmdb_id: 6704, color: 'from-yellow-300 to-yellow-500', icon: '' },
  { slug: 'ghibli', name: 'Studio Ghibli', tmdb_id: 10342, color: 'from-sky-300 to-blue-500', icon: '' },
  { slug: 'lucasfilm', name: 'Lucasfilm', tmdb_id: 1, color: 'from-amber-400 to-amber-600', icon: '' },
  { slug: '20th-century', name: '20th Century Studios', tmdb_id: 25, color: 'from-blue-300 to-blue-500', icon: '' },
  { slug: 'annapurna', name: 'Annapurna Pictures', tmdb_id: 49917, color: 'from-rose-400 to-red-600', icon: '' },
  { slug: 'new-line', name: 'New Line Cinema', tmdb_id: 12, color: 'from-purple-400 to-purple-600', icon: '' },
  { slug: 'blumhouse', name: 'Blumhouse', tmdb_id: 3172, color: 'from-red-600 to-red-900', icon: '' },
  // Prestige & indie
  { slug: 'legendary', name: 'Legendary', tmdb_id: 923, color: 'from-amber-500 to-amber-700', icon: '' },
  { slug: 'mgm', name: 'Metro-Goldwyn-Mayer', tmdb_id: 8411, color: 'from-yellow-400 to-amber-600', icon: '' },
  { slug: 'neon', name: 'Neon', tmdb_id: 90733, color: 'from-lime-400 to-green-500', icon: '' },
  { slug: 'participant', name: 'Participant', tmdb_id: 10039, color: 'from-teal-400 to-emerald-600', icon: '' },
  { slug: 'studiocanal', name: 'StudioCanal', tmdb_id: 694, color: 'from-blue-400 to-indigo-500', icon: '' },
  // Regional cinema
  { slug: 'bollywood', name: 'Bollywood', tmdb_id: null, language: 'hi', color: 'from-orange-400 to-pink-500', icon: '' },
  { slug: 'korean', name: 'Korean Cinema', tmdb_id: null, language: 'ko', color: 'from-rose-400 to-pink-600', icon: '' },
  { slug: 'anime', name: 'Anime Films', tmdb_id: null, language: 'ja', color: 'from-pink-400 to-fuchsia-600', icon: '' },
  { slug: 'toei', name: 'Toei Animation', tmdb_id: 5542, color: 'from-red-400 to-rose-600', icon: '' },
];
